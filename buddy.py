""" A minimal, highly abstract framework for an LLM-based AI buddy.
...
# ---------------------------------------------------------------------------
# Sorry, this part is highly abstract, just to define the behavior of the
# runtime cognition loop.
...
# And yeah, that's just the Runtime and its interface alone. I'm sweating
# thinking about where this is going.
# ---------------------------------------------------------------------------

# ---------------------------------------------------------------------------
# I'm actually not sure what concrete implementations to provide here. I will
# try to make something somewhere else and see what to add here.
