...
Yes, it's 2026 and I'm just getting into LLM orchestration.

The thing is, with a human "assistant", you get to know each other, you think
for and care about each other; you and the assistant become two sides of the
same entity.
...
*Barely anything is implemented yet, but I need somewhere to write it down.*

- Event-action system
- Context maintained as list of mental items (cognemes) instead of plaintext
- Dungeon-style / Disco-Elysium-style prompts to guide actions
- Idle loop, reflection and exploration
